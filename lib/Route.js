...
export default class Route extends React.Component {
  ...
  static createRouteFromReactElement = (element, parentRoute) => {
    const { component, fetch, path, query, schema, store, variables: routeVariables = {} } = element.props;
    ...
    route.onEnter = (nextState, replace, callback) => {
      ...
      const compVariables = component.variables && component.variables(store.getState()) || {};
      const variables = { ...compVariables, ...routeVariables };
